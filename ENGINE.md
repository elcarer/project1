...
6. **Зазор между местностями**: баг из практики — вода и земля без общего перехода при
   ...
   подсветка нарушений при ручном рисовании. Проверено: минимальная дистанция земля↔вода
   ровно margin+1 после генерации, нарушения подсвечиваются и исчезают при генерации.
