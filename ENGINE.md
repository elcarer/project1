...
**priest_128** — первый персонаж, сгенерированный ИИ-пайплайном (SD-модель
Retro Diffusion + ControlNet openpose, без рисовальщика; исходники пайплайна
вне репозитория — D:\ZCode\ComfyUI). Тот же стандарт 5×11, 43 кадра, fps 8.
Особенность: тень/контакт с землёй «плавают» между кадрами, death-стадии
слабые (модель не кладёт персонажа на землю) — при необходимости заменить
процедурным рисовальщиком.
