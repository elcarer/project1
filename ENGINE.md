...
| Сущностей | До culling | С culling (render + анимация) |
|---|---|---|
| 3 561 | 144 FPS / 6.95 мс | 144 FPS / 6.95 мс |
| 7 561 | 132 FPS / 8.2 мс | ~120 FPS / ~9 мс |
| 11 561 | ~90 FPS (интерп.) | 96 FPS / 11.6 мс |
| 15 561 | 62 FPS / 17.4 мс | ~70 FPS / ~15 мс |
| 19 561 | ~45 FPS (интерп.) | 51 FPS / 20.8 мс |
| 23 561 | 35.5 FPS / 28.5 мс | 42.6 FPS / 24 мс (+20%) |

Порог «без лагов» (≥60 FPS) сдвинулся с **~15 тыс. до ~17–18 тыс.** сущностей. A/B-замер
чистого culling-а на 23.5k (21 тыс. спрайтов вне кадра скрыты): 26.0 → 21.1 мс (−19%).
